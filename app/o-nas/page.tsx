...
const STATS = [
  { value: "13+", label: "Zápasov v ponuke" },
  { value: "5", label: "Európske ligy" },
    ...
    <div style={{ minHeight: "100vh", background: "#F4F1EA", color: "#1A1208" }}>
      ...
      <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "80px 40px 60px" }}>
        ...
        <h1 style={{
          ...
          Futbal naživo.<br />
          <span style={{ color: "#D8B35A" }}>Pre každého.</span>
        </h1>
        <p style={{
          fontFamily: "var(--font-geist)", fontSize: "1rem",
          color: "#8C7A56", lineHeight: 1.75, maxWidth: "560px",
        }}>
      ...
      {/* Stats */}
      <div style={{ borderTop: "1px solid #DDD7C8", borderBottom: "1px solid #DDD7C8", background: "#EDE9DF" }}>
        <div style={{
          ...
          {STATS.map(({ value, label }, i) => (
            <div key={label} style={{
              flex: "1 1 200px",
              padding: "40px 32px",
              borderRight: i < STATS.length - 1 ? "1px solid #DDD7C8" : "none",
            }}>
              <div style={{
                fontFamily: "var(--font-antonio)", fontWeight: 700,
                fontSize: "3.5rem", color: "#D8B35A", lineHeight: 1,
                marginBottom: "8px",
              }}>
                {value}
              </div>
              <div style={{
                ...
                color: "#8C7A56", textTransform: "uppercase",
                letterSpacing: "0.1em",
              }}>
                {label}
              </div>
        ...
        >
          <div>
            <h2 style={{
              ...
              Prečo<br />
              <span style={{ color: "#D8B35A" }}>Goolvia?</span>
            </h2>
            <p style={{
              fontFamily: "var(--font-geist)", fontSize: "0.92rem",
              color: "#8C7A56", lineHeight: 1.75, marginBottom: "20px",
            }}>
            ...
            {VALUES.map(({ icon, title, desc }) => (
              <div key={title} style={{
                ...
                <div>
                  ...
                  <p style={{
                    fontFamily: "var(--font-geist)", fontSize: "0.78rem",
                    color: "#8C7A56", lineHeight: 1.65, margin: 0,
                  }}>
                    {desc}
                  </p>
                </div>
      ...
      {/* CTA */}
      <div style={{
        borderTop: "1px solid #DDD7C8", background: "#1A1208",
        ...
        <h2 style={{
          ...
          Pripravený na<br />
          <span style={{ color: "#D8B35A" }}>prvý zápas?</span>
        </h2>
        <a href="/#zapasy" style={{
          ...
          background: "#D8B35A", padding: "16px 36px",
          borderRadius: "8px",
